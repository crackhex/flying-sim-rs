...
pub const fn update_flying_yaw(m: &mut MarioState) {
...
pub const fn update_flying_pitch(m: &mut MarioState) {
...
pub const fn update_flying(m: &mut MarioState) {
...
pub const fn perform_air_step(m: &mut MarioState) {
